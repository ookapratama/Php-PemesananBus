               ...
               <div class="section-body">
                  ...
                  <div class="row">
                     <div class="col-12 ">
                        <div class="card">
                           <div class="card-body">
                              <form action="store_jadwal.php" method="POST" enctype="multipart/form-data">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-3">
                                       ...
                                       <div class="form-group">
                                          <input type="text" name="terminal_asal" class="form-control" placeholder="ex : Makassar" />
                                       </div>
                                    </div>
                                    <div class="col-md-3">
                                       <label for="">Terminal Tujuan</label>
                                       <div class="form-group">
                                          <input type="text" placeholder="ex : Toraja" name="terminal_tujuan" class="form-control" />
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-3">
                                       ...
                                       <div class="form-group">
                                          <input type="time" name="waktu_berangkat" class="form-control" id="">
                                       </div>
                                    </div>
                                    <div class="col-md-3">
                                       <label for="">Harga</label>
                                       <div class="form-group">
                                          <input type="number"  name="harga_bus" class="form-control">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="d-flex">
