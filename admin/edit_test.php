...
$id = $_GET['id'];
$datas = select('test WHERE id_test = ' . $id);
                        ...
                        <div class="card">
                           <div class="card-body">
                              <form action="update_test.php" method="POST" enctype="multipart/form-data">
                                 <input type="hidden" name="id_test" value="<?= $data['id_test'] ?>">
                                 <div class="row">
                                    <div class="col-md-4">
                                       <label for="">Nama </label>
                                       <div class="form-group">
                                             <input type="text" name="nama" class="form-control" placeholder="Masukkan Username" value="<?= $data['nama'] ?>" />
                                       </div>
                                    </div>
